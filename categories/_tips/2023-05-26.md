...
Antes de seguir com o nosso conteúdo, é preciso definir alguns termos que serão usados durante a explicação. A ideia é aqui é criar um glossário e definir a natureza do RAD.

**Método**:** **Uma abordagem sistemática e estruturada para alcançar um objetivo. A abordagem ser "sistemática e estruturada" significa que ela é organizada em algum nível. Não se chega ao objetivo de qualquer jeito. 
