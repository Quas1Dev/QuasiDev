...
O RAD é uma metodologia. Mas o que é uma metodologia? A principio, metodologia pode se referir ao estudo do do método — o exame sistemático e a compreensão de como as coisas são feitas. Essa interpretação é cabível devido a construção da palavra, que junta os termos "". Mas conforme o tempo passa, as palavras podem carregar significados diferentes, a depender do contexto onde são usadas. 

Metodologia, em seu sentido geral, refere-se a um conjunto de princípios, métodos e técnicas sistemáticas que orientam a realização de um determinado processo ou atividade. No contexto do desenvolvimento de software, a metodologia desempenha um papel fundamental na organização e estruturação de um projeto, fornecendo diretrizes claras e estabelecendo uma estrutura sólida para o desenvolvimento de aplicativos.
