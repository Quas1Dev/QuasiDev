...
**Método**:** **Uma abordagem sistemática e estruturada para alcançar um objetivo.
...
**Princípios**: são conceitos fundamentais que guiam o pensamento que leva a definição de uma abordagem definida por uma metodologia. 
