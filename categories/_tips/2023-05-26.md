...
**Princípios**: referem-se a regras, diretrizes ou crenças fundamentais que orientam o comportamento, a tomada de decisões ou a aplicação de métodos. São conceitos ou valores fundamentais que regem ações e práticas. Os princípios são derivados de teoria, experiência ou normas estabelecidas e servem como base para fazer escolhas éticas, consistentes e eficazes.

Os princípios sustentam o desenvolvimento e aplicação de métodos, processos e metodologias. Eles fornecem a estrutura de orientação para a tomada de decisões e a seleção de métodos ou técnicas apropriadas. Os princípios informam o design e a execução de métodos e processos para garantir o alinhamento com os resultados desejados e os padrões éticos.
