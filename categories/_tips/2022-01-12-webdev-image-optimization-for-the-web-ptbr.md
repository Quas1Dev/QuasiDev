---
title: O que fazer para otimizar imagens para a web?
layout: article
permalink: "/web-dev/:title"
description: Ter imagens e uma página rápida é possível, e aqui eu explico como você
  pode fazer isso.
categories:
- Desenvolvimento Web
tags: imagem, otimização, web, pagespeed
date: 2022-01-12T03:00:00.000+00:00
lastUpdated: 2022-09-29 19:51:00 +0000
author: Fernando
...
Em uma situação normal, para exibir o conteúdo de uma página, o navegador precisa antes baixar todos os recursos referenciados durante o documento HTML. Isso inclui, além dos arquivos JS e CSS, todas as imagens linkadas na página. Se tiver 20 imagens, serão baixadas 20 imagens antes que qualquer coisa seja exibida. Enquanto isso, o usuário deve esperar olhando para uma página em branco por alguns segundos, o que pode ser tempo suficiente para que ele/ela desista e procure outro site sobre o assunto.

Felizmente temos técnicas que podemos aplicar para evitar esse tipo de problema. Aqui vamos citar algumas soluções que nos permite ter páginas carregando rápido, mesmo com muitas imagens.
...
## Adie o carregamento de imagens
