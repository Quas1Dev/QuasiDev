...
---
Se o seu computador está com o armazenamento cheio, ele pode começar a apresentar sérios problemas de performance. Se está tendo algum problema de performance, pode ser o momento de limpar o sistema de armazenamento do seu computador. Nas seções abaixo são descritas algumas práticas que podem ajudar a recuperar espaço no dispositivo de armazenamento. <!--more-->
