...
Tendo uma descrição da página, e o conteúdo das páginas separados em arquivos próprios, nós podemos estabelecer um processo otimizado de construção do site, que consiste em pegar o conteúdo especifico de cada página e combinar com uma cópia do template.
