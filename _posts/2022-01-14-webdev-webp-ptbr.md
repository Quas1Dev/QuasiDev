...
[**cwebp**](https://developers.google.com/speed/webp/docs/cwebp){: rel="norefer noopener nofollow"} Para compressão WebP sem perdas (lossless). Foi utilizado com o comando ```-lossless -q 100 -m 6```.
