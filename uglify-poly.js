...
let code = {
	'sources/intersection-observer.js': fs.readFileSync('_scripts/sources/intersection-observer.js','utf8')
};
...
fs.writeFile('_scripts/polyfills/inob.js.map', result.map.toString(),checkErr)
fs.writeFile('_scripts/polyfills/inob.min.js', result.code, checkErr);
/*=== ONLY UGLIFY CODE ===*/
// take code
